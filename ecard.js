...
function saveContact() {
    const name = 'Rafia Tug Jannat';
    const organization = 'Roaming Tours & Travels';
    const title = 'Executive (Visa Department)';
    const officePhone = '+8801622771122';
    // const personalPhone = '+8801312030501';
    const email = 'rafiaroaming25@gmail.com';
...
function openWhatsApp() {
    const whatsappNumber = '8801622771122';
